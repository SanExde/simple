...
%readmore`.trimStart(),
  ...
  footer: '⟣─════──════─⟢\n',
  after: `  ${'\n*Note* :\nJika Melanggar Akan Kena baned\n'}`,
}
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    let url = 'https://i.ibb.co/RQ785c2/Img-Resizer-20221104-2335-26922.jpg'
...
`, text.trim(), flaa, [
    ...
    ], m, { 'document':{'url':'https://youtu.be/FS4QIXVC7es'},
