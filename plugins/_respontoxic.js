...
*New Script by SanXd Official*

*OFFICIAL GROUP*
_https://chat.whatsapp.com/CHiZqxrzfQIBoOX8cdOWiE_

*YOUTUBE OFFICIAL*
_https://youtu.be/FS4QIXVC7es_
────────`
  let _muptime
    if (process.send) {
      process.send('uptime')
...
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        ...
                        mediaType: 2,
                        description: `Create By SanXd`,
                        title: `My Ultah: ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`,
                        body: `Create By SanXd`,          previewType: 0,
